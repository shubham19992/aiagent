...
export const DUMMY_OPS = [
  ...
  { code: 'llmops', name: 'LLMOps', description: 'Large language model operations - prompt, evaluation, and serving lifecycle.', is_active: true, sort_order: 1 },
  { code: 'infraops', name: 'InfraOps', description: 'Infrastructure operations - provisioning, scaling, and lifecycle of infrastructure.', is_active: true, sort_order: 2 },
  { code: 'finops', name: 'FinOps', description: 'Cloud financial operations - cost visibility, allocation, and optimization.', is_active: true, sort_order: 3 },
